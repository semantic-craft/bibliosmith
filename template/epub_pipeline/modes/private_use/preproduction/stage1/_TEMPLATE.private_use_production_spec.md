...
Private-use covers must be visually complete but must not present the book as a public-domain or BiblioSmith-published edition.

私人自用封面必须完整可读，但不得把书包装成公版或 BiblioSmith 项目出版版本。
