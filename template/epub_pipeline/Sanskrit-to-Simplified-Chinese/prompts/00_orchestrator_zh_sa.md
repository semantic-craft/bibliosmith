...
6. `references/sanskrit_source_notes.md`
7. `references/sanskrit_source_types.md`
8. `references/sanskrit_textual_criticism_policy.md`
9. `references/sanskrit_reference_translation_policy.md`
10. `references/sanskrit_names_transliteration_policy.md`
11. `references/sanskrit_title_strategy.md`
...
16. `references/sanskrit_to_chinese_translation_notes.md`
...
1. `01_ingest_clean_zh_sa.md`
2. `02_split_zh_sa.md`
3. `03_global_translation_research_zh_sa.md`
4. `04_book_specific_research_zh_sa.md`
5. `05_pretranslation_trials_zh_sa.md`
6. `06_glossary_style_zh_sa.md`
7. `07_translate_chapters_zh_sa.md`
8. `08a_chapter_post_translation_control_zh_sa.md`
9. `08_review_fidelity_zh_sa.md`
10. `09_review_readability_imagery_zh_sa.md`
11. `10_review_terminology_zh_sa.md`
12. `11_chapter_quality_gate_zh_sa.md`
13. `13_preproduction_stage1_spec_zh_sa.md`
14. `14_preproduction_stage2_sample_zh_sa.md`
15. `15_full_book_production_zh_sa.md`
16. `prompts/16a_stratified_random_spotcheck.md`
17. `16_independent_review_agents_zh_sa.md`
18. `17_revision_routing_zh_sa.md`
19. `prompts/18a_release_versioning.md`
20. `18_final_output_zh_sa.md`
21. `19_retrospective_template_update_zh_sa.md`
