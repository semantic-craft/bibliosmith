# 梵语标题与章节题名策略 / Sanskrit Title Strategy

## 基本原则

梵语作品常见卷、书、章、节、命题、问题、论题等多层结构。不得把现代编辑者目录直接当成原作标题。
...
- 标题中的出现不计入“正文首次出现”。
- 梵语原名、拉丁化转写或参考译本中的外文名应放在正文第一次自然出现处、译注或术语表中。
...
- 禁止在章节标题、副标题或目录题名中写 `中文名（Sanskrit/Latin transliteration）`。
- 禁止把 AI 内容概括变成读者可见标题。
