---
name: German-to-Simplified-Chinese
...
4. 使用 `books/scripts/create_book_project.py` 创建工程，复制顺序为 `common -> German-to-Simplified-Chinese`；若书籍属于专业/学术控制对象，再叠加合适 profile。
