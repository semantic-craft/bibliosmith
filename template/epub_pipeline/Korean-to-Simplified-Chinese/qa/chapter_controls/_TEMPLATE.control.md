...
8. 是否按 `metadata/korean_source_profile.md` 和 `qa/textual/korean_textual_notes.md` 处理旧字、韩文/汉字混排、底本注、OCR 疑难和异读。
...
- 韩语/朝鲜语底本文字形态、敬语/称谓和官能/心理边界没有未处理风险。
