...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            book_pipeline::list_translation_prompt_packs,
            book_pipeline::get_translation_prompt_pack_default,
            book_pipeline::copy_translation_prompt_pack,
            book_pipeline::save_translation_prompt_pack_revision,
            book_pipeline::delete_translation_prompt_pack,
            book_pipeline::set_translation_prompt_pack_default,
            book_pipeline::diff_translation_prompt_pack_revisions,
            book_pipeline::select_book_translation_prompt_pack,
            book_pipeline::preview_book_translation_prompt,
