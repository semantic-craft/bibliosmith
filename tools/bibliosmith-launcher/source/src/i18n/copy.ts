...
const zhCN = {
  ...
  yes: "是",
  no: "否",
  refreshAllStarted: "正在刷新 BiblioSmith 与 OpenCode 状态",
  refreshBiblioSmithStep: "正在更新 BiblioSmith 项目...",
  refreshOpenCodeStep: "正在检测 OpenCode 客户端...",
  refreshAllDone: "BiblioSmith 与 OpenCode 状态已刷新完成",
...
const zhTW: Copy = {
  ...
  retry: "重試",
  close: "關閉",
  refreshAllStarted: "正在刷新 BiblioSmith 與 OpenCode 狀態",
  refreshBiblioSmithStep: "正在更新 BiblioSmith 專案...",
  refreshOpenCodeStep: "正在偵測 OpenCode 用戶端...",
  refreshAllDone: "BiblioSmith 與 OpenCode 狀態已刷新完成",
  updateBiblioSmithProject: "更新 BiblioSmith",
...
const ja: Copy = {
  ...
  retry: "再試行",
  close: "閉じる",
  refreshAllStarted: "BiblioSmith と OpenCode の状態を更新しています",
  refreshBiblioSmithStep: "BiblioSmith プロジェクトを更新しています...",
  refreshOpenCodeStep: "OpenCode クライアントを確認しています...",
  refreshAllDone: "BiblioSmith と OpenCode の状態を更新しました",
...
const en: Copy = {
  ...
  refreshAllStarted: "Refreshing BiblioSmith and OpenCode status",
  refreshBiblioSmithStep: "Updating BiblioSmith project...",
  refreshOpenCodeStep: "Checking OpenCode client...",
  refreshAllDone: "BiblioSmith and OpenCode status refreshed",
