...
const zhCN = {
  ...
  proxySettingsDescription: "用于模型服务、运行环境下载等网络请求。常见本机代理端口：V2rayN HTTP 10809、SOCKS 10808；Clash HTTP 7890。",
  proxyEnable: "启用代理",
  proxyProtocol: "协议",
  proxyHost: "IP/主机",
  proxyPort: "端口",
...
const zhTW: Copy = {
  ...
  proxySettingsDescription: "用於模型服務、執行環境下載等網路請求。常見本機代理埠：V2rayN HTTP 10809、SOCKS 10808；Clash HTTP 7890。",
  proxyEnable: "啟用代理",
  proxyProtocol: "協議",
  proxyHost: "IP/主機",
  proxyPort: "埠",
...
const ja: Copy = {
  ...
  proxySettingsDescription: "モデルサービスやランタイムのダウンロードなど、ネットワーク接続に使います。ローカルプロキシの例：V2rayN HTTP 10809、SOCKS 10808；Clash HTTP 7890。",
...
const en: Copy = {
  ...
  proxySettingsDescription: "Used for model services, runtime downloads, and other network requests. Common local ports: V2rayN HTTP 10809, SOCKS 10808; Clash HTTP 7890.",
